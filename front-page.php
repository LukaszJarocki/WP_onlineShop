				...
				<div class="row pt-5">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white">Toys</h2>
						</a>
					</div>
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white">Food</h2>
						</a>
					</div>
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white">Care</h2>
						</a>
					</div>
				</div>
				...
				<div class="row mb-3">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
							<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
								...
								<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white">Accessories</h2>
							</a>
					</div>
