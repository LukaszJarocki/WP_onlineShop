...
?>
	...
	<main id="primary" class="site-main">
		...
		<section class="container">
				...
				<p class="text-center">
					We offer a number of hight quality toys to halp keep <br> your pets healthy and spoiled!
				</p>
				<div class="pt-5 pb-5">
				...
				<div class="row pt-5">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white" style="opacity: 0.8;">Toys</h2>
						</a>
					</div>
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white" style="opacity: 0.8;">Food</h2>
						</a>
					</div>
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white" style="opacity: 0.8;">Care</h2>
						</a>
					</div>
				</div>
				...
				<div class="row mb-3">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
							<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
								...
								<h2 class="position-absolute bottom-0 end-0 start-0 p-2 mb-0 text-center bg-primary-opacity-8 text-white" style="opacity: 0.8;">Accessories</h2>
							</a>
					</div>

					<div class="categories__col col-md-8 col-sm-12 mb-3">
							<a href="" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
								<div class="bg-sale position-absolute top-0 bottom-0 end-0 start-0" style="z-index: 1; opacity: 0.7;"></div>
								...
								<h2 class="position-absolute top-50 end-0 start-0 p-2 mb-0 text-center  text-white" style="z-index: 2">Special Offers</h2>
