	...
	<header id="masthead" class="site-header">
		...
		<div class="container pt-2 pb-2">
			<div class="row align-items-center">
				...
				<div class="col cart d-flex d-flex justify-content-center justify-content-md-end align-items-center pt-2">
					<a href="echo wc_get_cart_url();"><i class="bi bi-bag-dash p-2"></i></a>
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-center">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
							...
							<?php esc_html_e( 'Primary Menu', 'dogshop' ); ?>
						</button>
					</div>
